...
class Test():
  ...
  def test_(self):
    ...
    self.driver.find_element(By.NAME, "noibiz_name").send_keys("rh")
    self.driver.find_element(By.NAME, "noibiz_email").send_keys("rh@gmail.com")
    ...
    element = self.driver.find_element(By.NAME, "noibiz_gender")
